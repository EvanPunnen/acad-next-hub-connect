...
const SplashScreen = ({ onComplete }: SplashScreenProps) => {
  ...
  if (currentStep === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 flex items-center justify-center">
  ...
  if (currentStep === 2) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 flex items-center justify-center p-6">
        <div className="max-w-4xl text-center space-y-8 animate-fade-in">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80 text-xl">
              Select how you want to access AcadNext
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card
              className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl cursor-pointer"
              onClick={() => handlePortalSelection("student")}
            >
              <CardHeader className="text-center pb-4">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-2xl w-20 h-20 mx-auto mb-6 shadow-xl">
            ...
            >
              <CardHeader className="text-center pb-4">
                <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-6 rounded-2xl w-20 h-20 mx-auto mb-6 shadow-xl">
              ...
              <CardContent className="text-center space-y-6 pt-0">
                <p className="text-white/80 text-lg">
                  Manage students, track attendance, and handle administrative
                  tasks.
                </p>
                <div className="space-y-3 text-left">
                  <div className="flex items-center space-x-3 text-white/70">
                ...
                <Button className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <div className="max-w-6xl text-center space-y-8 animate-fade-in">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-8">
          ...
          <p className="text-white/70 mb-6 text-lg">
            Contact our support team for assistance with setup or any questions
            about the platform.
          </p>
        ...
        <Button
          ...
          className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white py-4 px-8 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-lg"
        >
          Get Started
        </Button>
      </div>
